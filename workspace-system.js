...
const WORKSPACE_DEFINITIONS = Object.freeze({
  ...Object.fromEntries(['procurement','sales','calendar'].map(id => [id, {
    ...
    sections: ['OVERVIEW',...BUSINESS_DOMAINS[id].entities.map(entity=>entity.toUpperCase()),...(id==='calendar'?['SCHEDULING','EVENT_PREPARATION','EXTERNAL_CALENDAR']:id==='sales'?['FORECAST']:[])],
