...
(async()=>{
  ...
  console.log(JSON.stringify({ok:true,version:'5.4.0',double_clap_gate:'pass',standby_privacy:'contract_pass',single_realtime_pipeline:'pass',renderer_failure_isolated:'pass',audio_failure_isolated:'pass',jarvis_handlers_after_failure:'pass',runtime_bound_visuals:'pass',fake_activity_removed:'pass'},null,2));
