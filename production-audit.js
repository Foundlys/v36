...
(async()=>{try{
  ...
  console.log(JSON.stringify({ok:true,version:'5.3.1',connectors_audited:93,status_contract:'pass',dedicated_routes:'pass',ui_contract:'pass',jarvis_pipeline:'pass'},null,2));
