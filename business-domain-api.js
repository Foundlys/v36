...
function createBusinessDomainApi({domains,platform,context,principal,readBody,sendJson,mailAccount=()=>null,mailSubmissions=()=>null,mailboxes=()=>null,mailOAuth=()=>null}){
  return async(req,res,url)=>{
    ...
    if(id==='analysis'&&!['reports','provider_reports','provider_events','owned-export','industry-kpis','cohorts','cohort_definitions','definition_revisions','analytic_models','schema'].includes(parts[0]))return false;
    try{
