...
(async()=>{try{
  ...
  console.log(JSON.stringify({ok:true,basic_auth_start:'pass',public_callbacks:'pass',providers:providers.map(x=>x.id),restart_persistence:'pass',tenant_binding:'pass',state_integrity:'pass',one_time_replay:'pass',transient_retry:'pass',encrypted_tokens:'pass',bootstrap_and_connected:'pass'},null,2));
