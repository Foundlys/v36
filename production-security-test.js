...
(async()=>{try{for(let i=0;i<60;i++){try{if((await fetch(base+'/api/health')).ok)break}catch{}await wait(100)}
  ...
  console.log(JSON.stringify({ok:true,authentication:'pass',runtime_auth_diagnostic:'pass',secret_exposure:'pass',tenant_header_isolation:'pass',ssrf_guard:'pass',readiness:'pass',oauth_start_gate:'pass',worker_retry:'pass'},null,2));
