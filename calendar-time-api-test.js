...
(async()=>{try{
 ...
 console.log('PASS authenticated calendar date rejection across writes/slots, half-hour ambiguity, retained source/revision after rejected edit, real recurrence conflicts and encrypted restart');
