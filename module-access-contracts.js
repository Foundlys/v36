...
const ENTITY_GROUPS={
  ...
  marketing:{campaigns:['campaigns','creatives','creative_revisions','experiments','creative_reviews'],audiences:['audiences'],attribution:['attribution','measurement']},
  procurement:{sourcing:['rfqs','bids'],suppliers:['suppliers'],opportunities:['opportunities','tasks','outcome_observations','economics_snapshots'],approvals:['quotes','orders','documents','approval_policies','awards']},
