...
const METHOD_CAPABILITIES={
  ...
  automation:{previewConfirmedAutomationRun:['automation:workflows','automation:runs'],submitConfirmedAutomationRun:['automation:workflows','automation:runs'],previewAutomationRun:['automation:workflows','automation:runs'],inspectAutomationRun:['automation:workflows','automation:runs'],automationDefinitions:['automation:workflows'],queryAutomationRuns:['automation:runs'],previewAutomationRecovery:['automation:workflows','automation:runs'],recoverAutomation:['automation:workflows','automation:runs'],verifyAutomationRecord:['automation:workflows'],setAutomationActivation:['automation:workflows'],defineAutomation:['automation:workflows'],recoverAutomationPublication:['automation:workflows'],recoverAutomationRunRequest:['automation:workflows','automation:runs'],runAutomation:['automation:workflows'],tickAutomations:['automation:workflows'],automationStatus:['automation:runs','automation:workflows'],automationRecords:['automation:workflows'],createAutomationRecord:['automation:workflows']},
