...
const ENTITY_GROUPS={
  ...
  marketing:{campaigns:['campaigns','journey_definitions','journey_runs','tasks','creatives','creative_revisions','creative_requests','creative_review_requests','experiments','creative_reviews'],audiences:['audiences','audience_members','audience_activations'],attribution:['attribution','measurement']},
