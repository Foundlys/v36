...
const ENTITY_GROUPS={
  ...
  finance:{invoices:['invoices','invoice_lines','credit_notes','source_documents','attachments','document-proposals','document_proposals'],payments:['payments','bank_accounts','bank_transactions','reconciliations','collection_actions'],reports:['reports','budgets','cash_forecasts','counterparty_balances','forecast_scenarios'],ledger:['legal_entities','fiscal_periods','periods','accounts','journals','journal_entries','journal_lines','debtors','creditors','cost_centers','projects','dimensions','assets','depreciations','asset_disposals','vat_codes','tax_periods','closing_periods','audit_events','ledger']},
  ...
  marketing:{campaigns:['campaigns','journey_definitions','journey_runs','tasks','creatives','creative_revisions','creative_requests','creative_review_requests','experiments','creative_reviews'],audiences:['audiences','audience_members','audience_activations','audience_requests'],attribution:['attribution','measurement']},
...
const METHOD_CAPABILITIES={
  ...
  automation:{previewAutomationResume:['automation:workflows','automation:runs'],resumeAutomation:['automation:workflows','automation:runs'],recoverAutomationResumeRequest:['automation:workflows','automation:runs'],recoverAutomationResultRequest:['automation:workflows','automation:runs'],submitNativeAutomationRun:['automation:workflows','automation:runs'],recoverAutomationActivationRequest:['automation:workflows'],previewAutomationApproval:['automation:workflows','automation:runs','automation:approvals'],recoverAutomationApprovalRequest:['automation:workflows','automation:runs','automation:approvals'],previewConfirmedAutomationRun:['automation:workflows','automation:runs'],submitConfirmedAutomationRun:['automation:workflows','automation:runs'],previewAutomationRun:['automation:workflows','automation:runs'],inspectAutomationRun:['automation:workflows','automation:runs'],automationDefinitions:['automation:workflows'],queryAutomationRuns:['automation:runs'],previewAutomationRecovery:['automation:workflows','automation:runs'],recoverAutomation:['automation:workflows','automation:runs'],verifyAutomationRecord:['automation:workflows'],setAutomationActivation:['automation:workflows'],defineAutomation:['automation:workflows'],recoverAutomationPublication:['automation:workflows'],recoverAutomationRunRequest:['automation:workflows','automation:runs'],runAutomation:['automation:workflows'],tickAutomations:['automation:workflows'],automationStatus:['automation:runs','automation:workflows'],automationRecords:['automation:workflows'],createAutomationRecord:['automation:workflows']},
...
const PROVIDER_ROUTES=[
  ...
  [/^\/api\/procurement\/outcome-observations$/, 'procurement:opportunities','write'],
  [/^\/api\/procurement\/suppliers\/[-A-Za-z0-9_.:]+\/outcomes$/, 'procurement:opportunities','read'],
  [/^\/api\/procurement\/rfqs\/[-A-Za-z0-9_.:]+\/economics-preview$/, 'procurement:opportunities','read'],
  [/^\/api\/procurement\/rfqs\/[-A-Za-z0-9_.:]+\/(?:incremental-)?allocation-preview$/, 'procurement:approvals','read'],
  [/^\/api\/marketing\/measurement\/(?:query|drilldown)$/, 'marketing:attribution','read'],
  [/^\/api\/finance\/forecast-scenarios$/, 'finance:reports','read'],
