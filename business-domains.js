...
class BusinessDomain {
  ...
  snapshotReadable(ctx,actor,row){return require('./analysis-definition-history').readable(this,ctx,actor,row)&& require('./sales-sequence-access').readable(this,ctx,actor,row)&& require('./sales-snapshot-access').snapshotReadable(this,ctx,actor,row)&&require('./marketing-creative-reviews').reviewReadable(this,ctx,actor,row)&&require('./communication-drafts').readable(this,ctx,actor,row)&&require('./communication-replies').readable(this,ctx,actor,row)&&require('./communication-templates').readable(this,ctx,actor,row);}
