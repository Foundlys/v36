...
const DEFINITIONS = Object.freeze({
  analysis:{legacy:'rapportages',primary:'reports',entities:['reports','provider_reports','provider_events','cohort_definitions','definition_revisions'],required:{definition_revisions:[],cohort_definitions:['title','cohort_definition'],reports:['title','content'],provider_reports:['title'],provider_events:['title']}},
