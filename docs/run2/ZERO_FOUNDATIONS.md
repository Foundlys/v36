...
The startup/standalone extension passed 12 locale unit/HTTP tests, the existing static-response failure/recovery/cancellation regression and the expanded standalone CRM regression. Full remote CI for this extension remains pending.
