...
CI follow-up: CI 216 failed in the native branching fixture due to approval-reference reuse across distinct runs. See `RECOVERED_STATE_ACTIVATION_RECOVERY.md` and the preserved CI 216 evidence for the correction and subsequent validation.
