        ...
        for(const message of model.items){
          ...
          details.addEventListener('toggle',async()=>{
            ...
            try{
              ...
              appendMailboxSourceDownload(record,body,active,view.request_context);appendCommunicationDeliveryReport(record,body,active);if(view.can_view_conversation)appendCommunicationConversation(record,body,active);
              if(view.can_write){
