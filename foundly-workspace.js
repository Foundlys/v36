...
(() => {
  ...
  const SECTION_COPY = Object.freeze({
    EXTERNAL_CALENDAR:['Externe agendadekking','Lees expliciet gekozen Google-agendatijd voor interne conflictcontrole.'],
