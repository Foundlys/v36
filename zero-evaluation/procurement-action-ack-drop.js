...
http.ServerResponse.prototype.end=function(...args){if(this.req?.headers['x-procurement-drop-reply']==='isolated-action-fixture'&&this.req.method==='POST'&&/^\/api\/(?:zero\/turn|procurement\/(?:rfqs\/[^/]+\/(?:awards|economics-snapshots)|orders\/[^/]+\/approvals|awards\/[^/]+\/(?:approve|cancel)|outcome-observations|clarifications(?:\/[^/]+\/(?:entries|collaborators))?))$/.test(this.req.url)&&this.statusCode>=200&&this.statusCode<300){this.destroy();return this;}return end.apply(this,args);};
