...
function fixture(){
 ...
 Object.assign(f.context,{window:f.context,URLSearchParams,crypto:{randomUUID:()=> 'crm-dashboard-key'},setTimeout:()=>1,clearTimeout(){},setInterval:()=>1,clearInterval(){}});
